...
function AllTestimonial() {
    ...
    const handleFetchBanner = async () => {
        setLoading(true);
        try {
            const { data } = await axios.get('http://localhost:5001/api/v1/get-all-testimonial');
    ...
    const handleUpdateActive = async (id, currentStatus) => {
        ...
        try {
            ...
            const res = await axios.put(`http://localhost:5001/api/v1/update-testimonial-status/${id}`, {
    ...
    const handleDeleteBanner = async (id) => {
        setLoading(true);
        try {
            await axios.delete(`http://localhost:5001/api/v1/delete-testimonial/${id}`);
