...
const AllProperty = () => {
    ...
    const fetchProperties = async () => {
        setLoading(true);
        try {
            const { data } = await axios.get('https://www.test.blueaceindia.com/api/v1/get_properties');
    ...
    const handleDeleteProperty = async (id, publicId) => {
        try {
            setLoading(true);
            await axios.delete(`https://www.test.blueaceindia.com/api/v1/delete_property/${id}`, {
                data: { publicId },
            });
