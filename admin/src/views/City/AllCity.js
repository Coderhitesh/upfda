...
const AllCity = () => {
    ...
    const fetchLocations = async () => {
        setLoading(true);
        try {
            const { data } = await axios.get('https://www.test.blueaceindia.com/api/v1/get_locations');
    ...
    const handleDeleteLocation = async (id) => {
        try {
            setLoading(true);
            await axios.delete(`https://www.test.blueaceindia.com/api/v1/delete_location/${id}`);
